...
pilotStartDate <- as.Date("11/1/2017", format = "%m/%d/%y") # insert the pilot's start date in US format e.g., as.Date("01/25/18", format = "%m/%d/%y")
...
```{r} 
reportObject <- reproCheck(reportedValue="56.0", obtainedValue=55.9, valueType = 'n')
```
...
```{r}
reportObject <- reproCheck(reportedValue="68.1", obtainedValue=68.2, valueType = 'n')
```
